...
theme.color = {
	...
	text      = "#A379C9",
	urgent    = "#ff0000",
	highlight = "#54414E", -- Text color when highlighted.
...
theme.useless_gap         = dpi(0)  -- useless gap
...
theme.desktop.grid = {
	...
	height = { dpi(180), dpi(180), dpi(18), dpi(18), dpi(180), dpi(180) },
...
theme.naughty.base = {
	...
	fg           = theme.color.text,
	height       = dpi(theme.float.notify.geometry.height),
	width        = dpi(theme.float.notify.geometry.width),
	border_width = dpi(4),
